export default function SplitCTA() {
  return (
    ...
    >
      ...
      {/* yellow dot above the dashboard */}
      <span
        className="hidden md:block absolute top-[3%] left-[17%] w-[52px] h-[52px] rounded-full z-10 pointer-events-none"
        style={{
          background:
            "radial-gradient(circle at 35% 30%, #fcd35a 0%, #f6bb35 72%)",
        }}
        aria-hidden="true"
      />
      {/* blue dot below the Get Started button */}
      <span
        className="hidden md:block absolute bottom-[9%] right-[19%] w-[28px] h-[28px] rounded-full z-10 pointer-events-none"
        style={{
          background:
            "radial-gradient(circle at 35% 30%, #4f96c8 0%, #356f9f 75%)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="grid md:grid-cols-2 items-center gap-8 md:gap-0">
        ...
        <div className="relative px-6 lg:px-12 pb-16 md:py-24 max-w-xl">
          <p className="text-royal font-semibold text-sm mb-3">
            Are you ready?
          </p>
